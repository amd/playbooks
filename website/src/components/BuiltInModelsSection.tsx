                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-2">
                      ...
                      <div className="flex items-center gap-2 text-xs shrink-0">
                        <svg className="w-4 h-4 text-[#888888]" viewBox="0 0 24 24" fill="currentColor" title="Windows">
                          <path d="M3 12V6.75l6-1.32v6.48L3 12zm17-9v8.75l-10 .15V5.21L20 3zM3 13l6 .09v6.81l-6-1.15V13zm7 .25l10 .15V21l-10-1.91V13.25z"/>
                        </svg>
                        <svg className="w-4 h-4 text-[#888888]" viewBox="0 0 24 24" fill="currentColor" title="Linux">

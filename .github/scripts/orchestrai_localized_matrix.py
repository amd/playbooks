...
"""
OrchestrAI localized matrix/batch builder
=========================================

Turns a list of localized playbook IDs into:
...
Usage:
    orchestrai_localized_matrix.py --playbooks '["comfyui-image-gen", ...]' \
        [--locale zh-CN] [--config .github/orchestrai-config.yml] [--print]
...
from build_localized_test_matrix import load_merged_metadata
...
def build(playbooks, cfg, devices=None, platforms=None, locale="zh-CN"):
...
def main():
    ...
    ap.add_argument("--locale", default=os.environ.get("LOCALE", "zh-CN"),
                    help="locale under localized-playbooks (default: zh-CN)")
    args = ap.parse_args()

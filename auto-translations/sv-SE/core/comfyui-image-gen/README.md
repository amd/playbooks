...
> [!IMPORTANT]
> Denna spelbok använder särskilda taggar som GitHub inte kan visa. Besök [amd.com/playbooks](https://amd.com/playbooks) för att förhandsgranska innehållet korrekt.
<!-- @github-only:end -->

...
<!-- @github-only -->
> [!IMPORTANT]
> Denna spelbok använder AMD Playbooks-kommentartaggar som tolkas av
> AMD Playbooks-webbplatsen. GitHub renderar Markdown-innehållet, men inte
> direktiven för enhet, OS, variabler eller dolda tester.
<!-- @github-only:end -->

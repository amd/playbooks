...
<!-- @github-only -->
> [!IMPORTANT]
> Den här spelboken använder speciella taggar som GitHub inte kan rendera. Besök [amd.com/playbooks](https://amd.com/playbooks) för att förhandsgranska innehållet korrekt.
<!-- @github-only:end -->

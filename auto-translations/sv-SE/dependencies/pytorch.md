...
**Installera PyTorch med AMD ROCm™-programvarustöd** i den skapade virtuella miljön:
...
För andra enheter, se [den här länken](https://rocm.docs.amd.com/en/7.13.0-preview/frameworks/pytorch/install.html) för fullständiga instruktioner.
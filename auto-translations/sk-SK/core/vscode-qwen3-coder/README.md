...
<!-- @github-only -->
> [!IMPORTANT]
> Táto príručka používa špeciálne značky, ktoré GitHub nedokáže vykresliť. Pre správne zobrazenie tohto obsahu prosím navštívte [amd.com/playbooks](https://amd.com/playbooks).
<!-- @github-only:end -->

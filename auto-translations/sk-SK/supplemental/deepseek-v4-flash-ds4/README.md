...
<!-- @github-only -->
> [!IMPORTANT]
> Táto príručka používa špeciálne značky, ktoré GitHub nedokáže vykresliť. Ak chcete tento obsah zobraziť správne, navštívte stránku [amd.com/playbooks](https://amd.com/playbooks).
<!-- @github-only:end -->

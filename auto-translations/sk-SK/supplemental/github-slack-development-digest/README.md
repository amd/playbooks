...
<!-- @github-only -->
> [!IMPORTANT]
> Tento playbook používa komentárové značky AMD Playbooks, ktoré interpretuje
> stránka AMD Playbooks. GitHub vykresľuje obsah Markdownu, ale nie direktívy
> týkajúce sa zariadenia, OS, premenných ani skrytých testov.
<!-- @github-only:end -->

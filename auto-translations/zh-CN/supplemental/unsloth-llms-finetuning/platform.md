...
| 组件 | 版本 | 说明 |
|---------------|-----------------|-----------------------------------|
| **PyTorch**   | 2.11.x + ROCm 7.13  | 已预装于 AMD Ryzen AI Halo 开发者平台；所有其他设备需手动安装 |
...
| 模型 | 参数量 | 大小 | 下载位置 |
|-------|------------|------|-------------------|
| **unsloth/gemma-4-E4B-it** | 8B | ~16GB | 从 Hugging Face 下载

模型将自动下载至 Hugging Face 缓存目录：`~/.cache/huggingface/hub/`

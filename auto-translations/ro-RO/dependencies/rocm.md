...
**Adăugați utilizatorul curent la grupurile render și video.** 
```bash
...
Pentru ajutor suplimentar la instalare, consultați [ROCm 7.14 Documentation](https://rocm.docs.amd.com/en/latest/install/rocm.html).
...
GAIA este framework-ul open-source al AMD pentru construirea de agenți AI care rulează local pe hardware AMD cu accelerare Ryzen AI.
...
Aceasta instalează Lemonade Server, descarcă modelele implicite și verifică configurarea.

...
|---------------|-----------------|-----------------------------------|
| **PyTorch**   | 2.9 sau mai nouă    | Preinstalat pe AMD Ryzen AI Halo Developer Platform; trebuie instalat manual pe toate celelalte dispozitive |
...
|-------|------------|------|-------------------|
| **openai/gpt-oss-20b** | 20B | ~40GB | Preinstalat pe AMD Ryzen AI Halo Developer Platform; trebuie instalat manual pe toate celelalte dispozitive |

Modelele vor fi descărcate automat în directorul cache Hugging Face:
- **Windows**: `C:\Users\<username>\.cache\huggingface\hub\`
- **Linux**: `~/.cache/huggingface/hub/`

Asigurați-vă că aveți cel puțin **50GB spațiu liber** pentru stocarea modelelor.

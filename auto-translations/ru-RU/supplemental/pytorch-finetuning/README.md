...
<!-- @github-only -->
> [!IMPORTANT]
> В этом сборнике инструкций используются специальные теги, которые GitHub не может отобразить. Пожалуйста, посетите [amd.com/playbooks](https://amd.com/playbooks) для корректного просмотра этого контента.
<!-- @github-only:end -->

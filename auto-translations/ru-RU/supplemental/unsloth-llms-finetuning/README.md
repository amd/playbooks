...
<!-- @github-only -->
> [!IMPORTANT]
> Данный playbook использует специальные теги, которые GitHub не может отобразить. Пожалуйста, посетите [amd.com/playbooks](https://amd.com/playbooks) для корректного просмотра этого содержимого.
<!-- @github-only:end -->

...
1. Baixe o executável de instalação para Windows em: https://update.code.visualstudio.com/1.108.2/win32-x64-user/stable.
2. Clique no arquivo baixado `VSCodeUserSetup-x64-1.108.2.exe` para instalar o VS Code.

<!-- @os:end -->

<!-- @os:linux -->

1. Baixe o pacote de instalação Debian em: https://update.code.visualstudio.com/1.108.2/linux-deb-x64/stable.
2. Clique no arquivo baixado `code_1.108.2-1769004815_amd64.deb` para instalar o VS Code.

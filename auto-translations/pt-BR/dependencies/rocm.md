...
> **Nota**: Certifique-se de que o ambiente virtual esteja ativo antes de continuar.
...
Para obter mais ajuda com a instalação, consulte a [Documentação do ROCm 7.14](https://rocm.docs.amd.com/en/latest/install/rocm.html).
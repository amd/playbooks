...
<!-- @device:halo_box -->
<!-- @os:windows -->
1. No Windows, abra um terminal no diretório de sua escolha e siga os comandos para criar um venv.
...
3. Inicializando o GAIA

Após a instalação, execute `gaia init` para configurar o Lemonade Server e baixar os modelos:

```bash
gaia init
```

Isso instala o Lemonade Server, baixa os modelos padrão e verifica a configuração.

...
> [!IMPORTANT]
> Questo playbook utilizza tag speciali che GitHub non riesce a visualizzare. Visita [amd.com/playbooks](https://amd.com/playbooks) per visualizzare correttamente questo contenuto.
<!-- @github-only:end -->

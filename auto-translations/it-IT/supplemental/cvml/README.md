...
> [!IMPORTANT]
> Questo playbook utilizza tag speciali che GitHub non è in grado di rendere correttamente. Visita [amd.com/playbooks](https://amd.com/playbooks) per visualizzare correttamente questo contenuto.

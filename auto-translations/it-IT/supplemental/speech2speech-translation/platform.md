...
|---------------|-----------------|-----------------------------------|
| **PyTorch**   | 2.8 o successiva | Preinstallato sulla AMD Ryzen AI Halo Developer Platform; deve essere installato manualmente su tutti gli altri dispositivi |
...
|---------|-----------|------------|-----------------------|
| **facebook/seamless-m4t-v2-large** | 2.3B | ~10GB | Preinstallato sulla AMD Ryzen AI Halo Developer Platform; deve essere installato manualmente su tutti gli altri dispositivi |

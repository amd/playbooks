...
2. Esegui il programma di installazione `.exe` e segui le istruzioni.
...
| `ollama pull <model>` | Scarica un modello senza eseguirlo |
...
L'app desktop mantiene una cronologia delle tue conversazioni nella barra laterale, rendendo facile rivisitare le chat precedenti.
<!-- @os:end -->

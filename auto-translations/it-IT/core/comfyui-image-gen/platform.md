...
ComfyUI deve essere preinstallato seguendo le istruzioni fornite nella [Guida all'installazione di ComfyUI](../../dependencies/comfyui.md).
...
Per verificare che i modelli siano posizionati correttamente, [visualizza in anteprima il playbook di ComfyUI utilizzando il sito web di onboarding](../../README.md#previewing-the-playbooks) e segui le istruzioni. I modelli sono posizionati correttamente se non viene visualizzata la pagina "Models not found" all'avvio del template Z-Image Turbo.
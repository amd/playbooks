...
**Tilføj den aktuelle bruger til render- og videogrupperne.** 
```bash
...
For yderligere hjælp til installation, se venligst dette [link](https://rocm.docs.amd.com/en/7.13.0-preview/install/rocm.html).
...
**Tilføj den aktuelle bruger til grupperne render og video.** 
```bash
...
For yderligere hjælp til installationen, se venligst dette [link](https://rocm.docs.amd.com/en/7.13.0-preview/install/rocm.html).
...
2. Brug derefter `pip` til at installere **Gaia**
...
3. Initialisering af GAIA

Efter installationen skal du køre `gaia init` for at konfigurere Lemonade Server og downloade modeller:

```bash
gaia init
```

Dette installerer Lemonade Server, downloader standardmodellerne og verificerer opsætningen.

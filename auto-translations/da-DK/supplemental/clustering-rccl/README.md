...
<!-- @github-only -->
> [!IMPORTANT]
> Denne playbook bruger specielle tags, som GitHub ikke kan gengive. Besøg [amd.com/playbooks](https://amd.com/playbooks) for at forhåndsvise dette indhold korrekt.
<!-- @github-only:end -->

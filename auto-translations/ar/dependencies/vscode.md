...
1. قم بتنزيل حزمة تثبيت Debian من: https://update.code.visualstudio.com/1.108.2/linux-deb-x64/stable.
2. انقر على الملف الذي تم تنزيله `code_1.108.2-1769004815_amd64.deb` لتثبيت VS Code.

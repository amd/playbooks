...
**Krok 1**: Zainstaluj główny silnik Podman oraz samodzielną wtyczkę do parsowania Compose V2.
...
```
**Krok 4**: Uruchom tymczasowy kontener testowy, aby sprawdzić, czy silnik może pomyślnie pobierać i uruchamiać obrazy.

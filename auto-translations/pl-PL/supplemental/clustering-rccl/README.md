...
<!-- @github-only -->
> [!IMPORTANT]
> Ten przewodnik wykorzystuje specjalne tagi, których GitHub nie potrafi wyrenderować. Odwiedź stronę [amd.com/playbooks](https://amd.com/playbooks), aby poprawnie wyświetlić tę zawartość.
<!-- @github-only:end -->

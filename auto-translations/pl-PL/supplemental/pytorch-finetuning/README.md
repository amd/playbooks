...
<!-- @github-only -->
> [!IMPORTANT]
> Ten poradnik wykorzystuje specjalne tagi, których GitHub nie potrafi wyrenderować. Odwiedź [amd.com/playbooks](https://amd.com/playbooks), aby poprawnie wyświetlić tę treść.
<!-- @github-only:end -->

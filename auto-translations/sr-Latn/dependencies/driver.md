...
Instalirajte AMD GPU drajver (amdgpu) koristeći tok Radeon Software for Linux (RSL). Za uputstva za vašu distribuciju, pogledajte [Instalirajte kernel drajver](https://rocm.docs.amd.com/en/7.13.0-preview/install/rocm.html).

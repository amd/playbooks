...
1. Preuzmite Windows instalacioni izvršni fajl sa: https://update.code.visualstudio.com/1.108.2/win32-x64-user/stable.
2. Kliknite na preuzeti fajl `VSCodeUserSetup-x64-1.108.2.exe` da biste instalirali VS Code.

<!-- @os:end -->

<!-- @os:linux -->

1. Preuzmite Debian instalacioni paket sa: https://update.code.visualstudio.com/1.108.2/linux-deb-x64/stable.
2. Kliknite na preuzeti fajl `code_1.108.2-1769004815_amd64.deb` da biste instalirali VS Code.

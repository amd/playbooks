...
|-----------|---------|-------|
| **Node.js** | 22.16+ | Unapred instaliran i dostupan u PATH na AMD Ryzen™ AI Halo Developer Platform; mora se ručno instalirati na svim ostalim uređajima |
| **Lemonade Server** | najnovija | Pokrenut na `http://localhost:13305/api/v1` |

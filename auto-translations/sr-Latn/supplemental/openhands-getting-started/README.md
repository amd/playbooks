...
<!-- @github-only -->
> [!IMPORTANT]
> Ovaj priručnik koristi AMD Playbooks oznake komentara koje tumači
> AMD Playbooks sajt. GitHub prikazuje Markdown sadržaj, ali ne i direktive
> za uređaj, OS, promenljive ili skrivene testove.
<!-- @github-only:end -->

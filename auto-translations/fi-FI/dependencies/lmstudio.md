...
<!-- @device:halo_box -->
LM Studio voidaan asentaa **AMD Ryzen™ AI Developer Centerin** kautta. Siirry **Updates**-välilehdelle ja asenna LM Studio, jos sitä ei ole vielä asennettu.

Jotta LM Studio näkee valmiiksi asennetut mallit, siirry kohtaan Settings > General > Models Directory. Vaihda sitten polku muotoon `C:\Users\Public\models`
...
> Vinkki: Asennuksen jälkeen käynnistä LM Studio kerran, jotta komentorivikäyttöliittymä (`lms`) alustuu.
...
<!-- @os:linux -->
> Huomautus: Voit valita joko .deb- tai AppImage-asennuksen. 
...
<!-- @device:halo_box -->
Jotta LM Studio näkee valmiiksi asennetut mallit, siirry kohtaan Settings > General > Models Directory. Vaihda sitten polku muotoon `/var/cache/models`.

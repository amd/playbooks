...
<!-- @github-only -->
> [!IMPORTANT]
> Tämä opas käyttää erikoismerkintöjä, joita GitHub ei osaa renderöidä. Käy osoitteessa [amd.com/playbooks](https://amd.com/playbooks) nähdäksesi tämän sisällön oikein esikatseltuna.
<!-- @github-only:end -->

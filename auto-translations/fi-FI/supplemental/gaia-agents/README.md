...
**Korvaa `_register_tools()`-metodi** `get_hardware_info`-työkalulla:
...
Suorita ja kokeile kysyä "Show me my system specs":
...
Suorita ja kokeile kysyä "What models are available?":
...
Suorita ja kokeile kysyä "What size LLM can I run?":

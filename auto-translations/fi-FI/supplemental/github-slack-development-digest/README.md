...
<!-- @github-only -->
> [!IMPORTANT]
> Tässä ohjekirjassa käytetään AMD Playbooks -kommenttitunnisteita, jotka AMD Playbooks -sivusto tulkitsee.
> GitHub renderöi Markdown-sisällön, mutta ei laite-, käyttöjärjestelmä-, muuttuja- tai piilotettujen testien direktiivejä.
<!-- @github-only:end -->

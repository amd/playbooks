...
<!-- @github-only -->
> [!IMPORTANT]
> Tässä ohjekirjassa käytetään erikoistageja, joita GitHub ei pysty renderöimään. Käy osoitteessa [amd.com/playbooks](https://amd.com/playbooks) nähdäksesi tämän sisällön oikein.
<!-- @github-only:end -->

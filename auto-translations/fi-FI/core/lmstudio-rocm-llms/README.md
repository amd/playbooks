...
> [!IMPORTANT]
> Tässä ohjekirjassa käytetään erityisiä tunnisteita, joita GitHub ei pysty renderöimään. Käy osoitteessa [amd.com/playbooks](https://amd.com/playbooks) tarkastellaksesi tätä sisältöä oikein.
<!-- @github-only:end -->

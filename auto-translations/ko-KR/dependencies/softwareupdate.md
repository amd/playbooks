...
시작하기 전에 Ryzen AI Halo에 최신 소프트웨어가 설치되어 있는지 확인하세요. **AMD Ryzen™ AI Developer Center**를 열고 앱 자체 및 추가 소프트웨어에 대해 사용 가능한 업데이트가 있는지 확인합니다.

<!-- @os:windows -->

**Updates** 탭으로 이동합니다. 업데이트가 있는 경우 설치한 후 계속하기 전에 재부팅하세요.
...
**Manage** 탭으로 이동합니다. 업데이트가 있는 경우 설치한 후 계속하기 전에 재부팅하세요.

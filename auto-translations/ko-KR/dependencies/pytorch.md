...
**생성된 가상 환경에 AMD ROCm™ 소프트웨어 지원이 포함된 PyTorch를 설치합니다:**
...
다른 디바이스의 경우, 전체 설치 지침은 [이 링크](https://rocm.docs.amd.com/en/7.13.0-preview/frameworks/pytorch/install.html)를 참조하십시오.
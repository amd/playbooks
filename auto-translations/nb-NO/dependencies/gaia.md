...
GAIA er AMDs åpen kildekode-rammeverk for å bygge AI-agenter som kjører lokalt på AMD-maskinvare med Ryzen AI-akselerasjon.
...
Dette installerer Lemonade Server, laster ned standardmodellene og verifiserer oppsettet.
...
> **Viktig**: Sørg for at Lemonade Server kjører før du bruker GAIA. GAIA krever at Lemonade Server startes manuelt.

For mer informasjon, se [GAIA-dokumentasjonen](https://amd-gaia.ai).
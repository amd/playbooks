...
<!-- @github-only -->
> [!IMPORTANT]
> Denne oppskriften bruker AMD Playbooks-kommentar-tagger som tolkes av
> AMD Playbooks-nettstedet. GitHub gjengir Markdown-innholdet, men ikke enhets-,
> OS-, variabel- eller skjulte testdirektiver.
<!-- @github-only:end -->

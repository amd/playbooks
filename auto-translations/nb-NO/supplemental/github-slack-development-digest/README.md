...
<!-- @github-only -->
> [!IMPORTANT]
> Denne oppskriften bruker AMD Playbooks-kommentartagger som blir tolket av
> AMD Playbooks-nettstedet. GitHub gjengir Markdown-innholdet, men ikke
> direktivene for enhet, OS, variabel eller skjult test.
<!-- @github-only:end -->

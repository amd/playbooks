...
ComfyUI bør være forhåndsinstallert ved hjelp av instruksjonene i [ComfyUI-installasjonsveiledningen](../../dependencies/comfyui.md).

## Nødvendige modeller

### Windows/Linux

Følgende modeller må være til stede i katalogen der ComfyUI er installert, inne i `models`-mappen.

| Modelltype | Filnavn | Størrelse | Plassering | Nedlasting |
|------------|----------|------|----------|----------|
...
For å teste om modellene er riktig plassert, [forhåndsvis ComfyUI-spilleboken via innføringsnettstedet](../../README.md#previewing-the-playbooks) og følg instruksjonene. Modellene er riktig plassert hvis ingen «Modeller ikke funnet»-side vises når Z-Image Turbo-malen startes.
...
Telepítse az AMD GPU illesztőprogramot (amdgpu) a Radeon Software for Linux (RSL) folyamat használatával. Az Ön disztribúciójára vonatkozó utasításokért lásd: [Install the kernel driver](https://rocm.docs.amd.com/en/7.13.0-preview/install/rocm.html).

...
> [!IMPORTANT]
> Ez a útmutató olyan speciális címkéket használ, amelyeket a GitHub nem tud megjeleníteni. Kérjük, látogasson el az [amd.com/playbooks](https://amd.com/playbooks) oldalra a tartalom megfelelő előnézetéhez.
<!-- @github-only:end -->

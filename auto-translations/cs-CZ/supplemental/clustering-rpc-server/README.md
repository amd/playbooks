...
<!-- @github-only -->
> [!IMPORTANT]
> Tato příručka používá speciální značky, které GitHub neumí zobrazit. Chcete-li si tento obsah správně prohlédnout, navštivte prosím [amd.com/playbooks](https://amd.com/playbooks).
<!-- @github-only:end -->

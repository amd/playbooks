...
วิธีดาวน์โหลดโมเดล Qwen3.5 9B:

1. กด "Ctrl" + "Shift" + "M" บนแป้นพิมพ์ หรือคลิกที่แท็บ "Discover" (ไอคอนแว่นขยาย) บนแถบด้านข้างซ้าย
2. ค้นหา `Qwen3.5 9B`
3. เลือกการ quantization (แนะนำ `Q4_K_M` ซึ่งเป็นตัวเลือกที่สมดุลระหว่างขนาดและคุณภาพ) แล้วคลิก Download
...
หากต้องการดาวน์โหลดโมเดลเพิ่มเติม คุณสามารถค้นหาได้ในแท็บ Discover และ LM Studio จะจัดการส่วนที่เหลือให้

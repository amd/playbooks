...
1. Download het Debian-installatiepakket van: https://update.code.visualstudio.com/1.108.2/linux-deb-x64/stable.
2. Klik op het gedownloade bestand `code_1.108.2-1769004815_amd64.deb` om VS Code te installeren.

...
<!-- @github-only -->
> [!IMPORTANT]
> Ce playbook utilise des balises de commentaires AMD Playbooks qui sont interprétées par le
> site AMD Playbooks. GitHub affiche le contenu Markdown, mais pas les directives
> relatives à l'appareil, au système d'exploitation, aux variables ou aux tests masqués.
<!-- @github-only:end -->

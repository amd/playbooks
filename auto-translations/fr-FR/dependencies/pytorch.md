...
Pour les autres appareils, veuillez consulter [ce lien](https://rocm.docs.amd.com/en/7.13.0-preview/frameworks/pytorch/install.html) pour obtenir toutes les instructions.
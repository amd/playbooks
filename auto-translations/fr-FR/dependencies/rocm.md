...
Pour obtenir de l'aide supplémentaire sur l'installation, veuillez consulter la [documentation ROCm 7.14](https://rocm.docs.amd.com/en/latest/install/rocm.html).
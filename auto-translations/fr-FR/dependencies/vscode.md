...
<!-- @device:halo_box -->
<!-- @os:windows -->
VS Code peut être installé depuis le **AMD Ryzen™ AI Developer Center**. Accédez à l'onglet **Updates** et installez VS Code s'il n'est pas déjà présent.
<!-- @os:end -->

<!-- @os:linux -->
VS Code peut être installé depuis le **AMD Ryzen™ AI Developer Center**. Accédez à l'onglet **Manage** et installez VS Code s'il n'est pas déjà présent.
<!-- @os:end -->
<!-- @device:end -->
...
1. Téléchargez l'exécutable d'installation Windows depuis : https://update.code.visualstudio.com/1.108.2/win32-x64-user/stable.
...
1. Téléchargez le paquet d'installation Debian depuis : https://update.code.visualstudio.com/1.108.2/linux-deb-x64/stable.

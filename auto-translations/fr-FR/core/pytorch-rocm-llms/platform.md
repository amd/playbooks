...
PyTorch avec support ROCm est préinstallé sur l'AMD Ryzen™ AI Halo Developer Platform. Pour tous les autres appareils, les utilisateurs doivent installer manuellement PyTorch avec support ROCm. Veuillez consulter la section correspondant à votre système d'exploitation :
...
|-------|------------|------|-------------------|
| **openai/gpt-oss-20b** | 20B | ~40Go | Préinstallé sur l'AMD Ryzen AI Halo Developer Platform ; doit être installé manuellement sur tous les autres appareils |

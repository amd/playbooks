...
<!-- @github-only -->
> [!IMPORTANT]
> У цьому playbook використовуються спеціальні теги, які GitHub не може відобразити. Перейдіть на [amd.com/playbooks](https://amd.com/playbooks), щоб коректно переглянути цей вміст.
<!-- @github-only:end -->

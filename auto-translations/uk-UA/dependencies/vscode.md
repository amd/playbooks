...
<!-- @device:halo_box -->
<!-- @os:windows -->
VS Code можна встановити з **AMD Ryzen™ AI Developer Center**. Перейдіть на вкладку **Updates** і встановіть VS Code, якщо його ще немає.
<!-- @os:end -->

<!-- @os:linux -->
VS Code можна встановити з **AMD Ryzen™ AI Developer Center**. Перейдіть на вкладку **Manage** і встановіть VS Code, якщо його ще немає.
<!-- @os:end -->
<!-- @device:end -->

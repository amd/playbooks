...
2. Знайдіть `Qwen3.5 9B`
3. Виберіть квантизацію (рекомендована `Q4_K_M` є хорошим балансом між розміром і якістю) та натисніть Download
...
Якщо ви бажаєте завантажити додаткові моделі, ви можете знайти їх на вкладці Discover, і LM Studio впорається з усім іншим.

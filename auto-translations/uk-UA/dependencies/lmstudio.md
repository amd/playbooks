...
<!-- @device:halo_box -->
LM Studio можна встановити з **AMD Ryzen™ AI Developer Center**. Перейдіть на вкладку **Updates** і встановіть LM Studio, якщо його ще немає.

Щоб LM Studio міг бачити попередньо встановлені моделі, перейдіть до Settings > General > Models Directory. Потім змініть шлях на `C:\Users\Public\models`
...
<!-- @os:linux -->
> Примітка: Ви можете встановити або .deb, або AppImage.
...
<!-- @device:halo_box -->
Щоб LM Studio міг бачити попередньо встановлені моделі, перейдіть до Settings > General > Models Directory. Потім змініть шлях на `/var/cache/models`.

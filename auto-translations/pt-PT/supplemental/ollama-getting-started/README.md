...
<!-- @github-only -->
> [!IMPORTANT]
> Este manual utiliza etiquetas especiais que o GitHub não consegue renderizar. Visite [amd.com/playbooks](https://amd.com/playbooks) para pré-visualizar corretamente este conteúdo.
<!-- @github-only:end -->
...
O Ollama carrega o modelo para a memória e coloca-o numa linha de comandos. Experimente perguntar-lhe algo:
...
### Exemplo em Python
Agora que já podemos aceder à API do Ollama de forma programática, vamos chamá-la a partir do Python.

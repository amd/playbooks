...
<!-- @github-only -->
> [!IMPORTANT]
> Este manual usa etiquetas especiais que o GitHub não consegue apresentar. Visite [amd.com/playbooks](https://amd.com/playbooks) para pré-visualizar corretamente este conteúdo.
<!-- @github-only:end -->

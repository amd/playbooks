...
<!-- @github-only -->
> [!IMPORTANT]
> Este manual utiliza etiquetas especiais que o GitHub não consegue apresentar. Visite [amd.com/playbooks](https://amd.com/playbooks) para pré-visualizar corretamente este conteúdo.
<!-- @github-only:end -->

...
<!-- @github-only -->
> [!IMPORTANT]
> Este manual utiliza etiquetas especiais que o GitHub não consegue processar. Visite [amd.com/playbooks](https://amd.com/playbooks) para visualizar corretamente este conteúdo.
<!-- @github-only:end -->

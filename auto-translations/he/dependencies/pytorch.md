...
**התקן את PyTorch עם תמיכה בתוכנת AMD ROCm™** בסביבה הווירטואלית שנוצרה:
...
עבור התקנים אחרים, אנא עיין ב[קישור זה](https://rocm.docs.amd.com/en/7.13.0-preview/frameworks/pytorch/install.html) לקבלת הוראות מלאות.
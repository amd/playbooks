...
<!-- @github-only -->
> [!IMPORTANT]
> Ta priročnik uporablja posebne oznake, ki jih GitHub ne more prikazati. Obiščite [amd.com/playbooks](https://amd.com/playbooks), da si to vsebino ogledate pravilno.
<!-- @github-only:end -->

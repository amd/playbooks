...
<!-- @github-only -->
> [!IMPORTANT]
> Ta vodnik uporablja posebne oznake, ki jih GitHub ne more prikazati. Obiščite [amd.com/playbooks](https://amd.com/playbooks), da si to vsebino pravilno ogledate.
<!-- @github-only:end -->

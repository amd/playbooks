...
<!-- @github-only -->
> [!IMPORTANT]
> Αυτό το εγχειρίδιο χρησιμοποιεί ειδικές ετικέτες που το GitHub δεν μπορεί να αποδώσει. Επισκεφθείτε το [amd.com/playbooks](https://amd.com/playbooks) για να προεπισκοπήσετε σωστά αυτό το περιεχόμενο.
<!-- @github-only:end -->

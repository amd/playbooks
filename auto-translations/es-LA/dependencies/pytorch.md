...
Para otros dispositivos, consulta [este enlace](https://rocm.docs.amd.com/en/7.13.0-preview/frameworks/pytorch/install.html) para conocer las instrucciones completas.
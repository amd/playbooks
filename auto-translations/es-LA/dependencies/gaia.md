...
<!-- @device:halo_box -->
<!-- @os:windows -->
1. En Windows, abre una terminal en el directorio de tu elección y sigue los comandos para crear un venv.
...
2. Luego, usa `pip` para instalar **Gaia**
...
Esto instala Lemonade Server, descarga los modelos predeterminados y verifica la configuración.

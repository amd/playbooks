...
### Descarga de Qwen3.5 9B en LM Studio
...
2. Busca `Qwen3.5 9B`
3. Selecciona una cuantización (la recomendada `Q4_K_M` es un buen equilibrio entre tamaño y calidad) y haz clic en Download

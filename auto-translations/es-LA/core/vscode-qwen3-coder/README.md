...
<!-- @github-only -->
> [!IMPORTANT]
> Este playbook utiliza etiquetas especiales que GitHub no puede renderizar. Por favor, visita [amd.com/playbooks](https://amd.com/playbooks) para previsualizar correctamente este contenido.
<!-- @github-only:end -->

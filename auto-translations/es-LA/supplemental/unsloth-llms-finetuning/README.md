...
> [!IMPORTANT]
> Este playbook usa etiquetas especiales que GitHub no puede renderizar. Visite [amd.com/playbooks](https://amd.com/playbooks) para obtener una vista previa correcta de este contenido.
<!-- @github-only:end -->

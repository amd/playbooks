...
<!-- @github-only -->
> [!IMPORTANT]
> Este manual utiliza etiquetas especiales que GitHub no puede renderizar. Visita [amd.com/playbooks](https://amd.com/playbooks) para previsualizar correctamente este contenido.
<!-- @github-only:end -->

...
> **Important:** Unsloth does not yet support the PyTorch 2.13 build that ships with ROCm 10. For this playbook, install **ROCm 7.14 with PyTorch 2.12** using the commands below. Do not use the ROCm 10 / PyTorch 2.13 packages.

...
<!-- @test:id=verify-torch timeout=300 hidden=True -->
import torch
...
**How it works:**
<!-- @test:id=test-vector-addition timeout=600 -->
```python
import torch
...
**Run:**
<!-- @test:id=run-vector-addition-add-one-kernel-py timeout=800 -->
```bash
...
<!-- @test:id=run-vector-addition-add-one-kernel-cu timeout=800 -->
```bash
...
<!-- @test:id=verify-vector-addition-add-one-kernel-so timeout=300 hidden=True -->
import os

...
|-----------|---------|-------|
| **Node.js** | 22.16+ | Pre-installed and available in PATH on the AMD Ryzen™ AI Halo Developer Platform (Halo Box); must be manually installed on all other devices (STX Halo, STX Point, Krackan Point , Radeon RX 7900 XT, Radeon RX 9070 XT) |
